...
/**
 * <p>Java class for RiskInformationNotification complex type.
 * 
...
@XmlType(name = "RiskInformationNotification", namespace = "http://checkout.google.com/schema/2", propOrder = {

})
public class RiskInformationNotification implements com.google.checkout.sdk.notifications.Notification {

    @XmlElement(namespace = "http://checkout.google.com/schema/2", required = true)
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar timestamp;
    @XmlElement(name = "risk-information", namespace = "http://checkout.google.com/schema/2", required = true)
