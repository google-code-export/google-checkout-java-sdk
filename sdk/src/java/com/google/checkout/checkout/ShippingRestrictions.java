...
public class ShippingRestrictions {
	 ...
	 * &lt;country-code&gt; element and optionally the
	 * &lt;postal-code-pattern&gt are subelements .
	 * 
	 * @param countryCode
	 *            The country code.
	...
	public void addAllowedPostalArea(String countryCode,
		...
		Element allowedAreas = Utils.findContainerElseCreate(document, root,
				"allowed-areas");
		Element pa = Utils.createNewContainer(document, allowedAreas,
				"postal-area");
	...
	public void addExcludedPostalArea(String countryCode,
		...
		Element excludedAreas = Utils.findContainerElseCreate(document, root,
				"excluded-areas");
		Element pa = Utils.createNewContainer(document, excludedAreas,
				"postal-area");
		Utils.createNewElementAndSet(document, pa, "country-code", countryCode);
		Utils.createNewElementAndSet(document, pa, "postal-code-pattern",
				postalCodePattern);
