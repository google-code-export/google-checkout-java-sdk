...
public class ShoppingCart {
    ...
    @XmlType(name = "", propOrder = {
        "giftMessageOrIncludeGiftReceiptOrDeliveryInstructions"
    })
    public static class BuyerMessages {
        ...
        protected List<Object> giftMessageOrIncludeGiftReceiptOrDeliveryInstructions;

        /**
         * Gets the value of the giftMessageOrIncludeGiftReceiptOrDeliveryInstructions property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the giftMessageOrIncludeGiftReceiptOrDeliveryInstructions property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getGiftMessageOrIncludeGiftReceiptOrDeliveryInstructions().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<Object> getGiftMessageOrIncludeGiftReceiptOrDeliveryInstructions() {
            if (giftMessageOrIncludeGiftReceiptOrDeliveryInstructions == null) {
                giftMessageOrIncludeGiftReceiptOrDeliveryInstructions = new ArrayList<Object>();
            }
            return this.giftMessageOrIncludeGiftReceiptOrDeliveryInstructions;
        }
