...
public class NewOrderNotificationTest extends TestCase {
  ...
  public void setUp() {
    newOrderNotificationMessage =
        TestUtils.readMessage("/new-order-notification-sample.xml");
  ...
  public void testStructuredName() {
    String newOrderNotificationMessage2 = TestUtils.readMessage("/new-order-notification-sample-with-structured-name.xml");
