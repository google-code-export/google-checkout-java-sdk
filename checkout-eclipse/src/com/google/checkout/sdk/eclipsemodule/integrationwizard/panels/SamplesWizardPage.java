...
public class SamplesWizardPage extends WizardPage {
  ...
  public void onEnterPage() {
    ...
    if (tempSettings.getSamplesDirectory() == null) {
      ...
      File file = 
        new File(uri.resolve(tempSettings.getProject().getName() + "/WebContent/checkout"));
    ...
    addSamplesCheckBox.setSelection(tempSettings.getAddSamples());
    samplesDirectoryTextField.setEnabled(tempSettings.getAddSamples());
    browseButton.setEnabled(tempSettings.getAddSamples());
  }
}
