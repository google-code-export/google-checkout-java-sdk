...
/**
 * small test for AuthorizationAmountNotificationHandler
 * @author inder
 */
public class AuthorizationAmountNotificationHandlerTest extends TestCase {
  ...
  public void testProcess() throws CheckoutException {
    ...
    String notificationMsg = TestUtils.readMessage(
        "/authorization-amount-notification-sample.xml");
