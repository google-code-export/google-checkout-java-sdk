...
public final class ProjectVisualPanel extends JPanel {
    ...
    private void refreshProjectList() {
        ...
        Project defaultProject = openProjects.getMainProject();
        String defaultName = null;
        if (defaultProject != null) {
            defaultName = defaultProject.getProjectDirectory().getName();
        }
        ...
        for (int i=0; i<projects.length; i++) {
            ...
            if (defaultProject != null && name.equals(defaultName)) {
