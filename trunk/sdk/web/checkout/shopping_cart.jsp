    ...
    <form action="shopping_cart.jsp" method="POST">
	  ...
	  <tr>
	    <td align="left">
          ...
          <tr>
            <td align="center">
     	      <a href="javascript:{postIt('Submit')}"><img src="https://checkout.google.com/buttons/checkout.gif?merchant_id=<%=mc.getMerchantId()%>&w=160&h=43&style=white&variant=text&loc=en_US" border="0"/></a>
            </td>
