...
/**
 * small test for ChargebackAmountNotificationHandler
 * @author inder
 */
public class ChargebackAmountNotificationHandlerTest extends TestCase {
  ...
  public void testProcess() throws CheckoutException {
    ...
    String notificationMsg = TestUtils.readMessage(
        "/chargeback-amount-notification-sample.xml");
