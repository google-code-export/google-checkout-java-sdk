...
/**
 * This class encapsulates the &lt;gift-certificate-result&gt; tag used as part
 * of the Merchant Calculation API.
 * 
 * @author simonjsmith
 * 
...
public class GiftCertificateResult extends MerchantCodeResult {
	 ...
	 */
	public GiftCertificateResult(boolean valid, float calculatedAmount,
			String currency, String code, String message) {
