...
public class CheckoutShoppingCartRequest extends AbstractCheckoutRequest {
  ...
  public void addFlatRateShippingMethod(String name, float cost,
    ...
    Element newShip = Utils.createNewContainer(document, shippingMethods,
        "flat-rate-shipping");
    ...
    if (restrictions != null) {
      Utils.importElements(document, newShip,
          new Element[] { restrictions.getRootElement() });
    }
  }
  ...
  public void addItem(String name, String description, float price,
    ...
    addItem(name, description, price, quantity, null,
        merchantPrivateItemData, null);
  }
  ...
  public void addItem(String name, String description, float price,
      int quantity, String merchantItemID,
      Element[] merchantPrivateItemData, String taxTableSelector) {
    ...
    if (merchantPrivateItemData != null) {
      Element privateItemData = Utils.createNewContainer(document, item,
          "merchant-private-item-data");
      Utils.importElements(document, privateItemData,
  ...
  public String getAnalyticsData() {
    ...
    Element mcfs = Utils.findElementOrContainer(document,
        checkoutFlowSupport, "merchant-checkout-flow-support");
    if (mcfs == null) {
      return "";
    }
  ...
  public Date getCartExpiration() {
    ...
    Element expiration = Utils.findElementOrContainer(document,
        shoppingCart, "cart-expiration");
    if (expiration == null) {
      return null;
    }
    return Utils.getElementDateValue(document, expiration,
        "good-until-date");
  }
  ...
  public String getContinueShoppingUrl() {
    ...
    return Utils.getElementStringValue(document, mcfs,
  ...
  public String getMerchantCalculationsUrl() {
    ...
    Element merchantCalcs = Utils.findElementOrContainer(document, mcfs,
  ...
  public boolean isMerchantCalculatedTax() {
    ...
    Element taxTables = Utils.findContainerElseCreate(document, mcfs,
        "tax-tables");
    if (taxTables == null) {
      return false;
    }
  ...
  public void setCartExpiration(Date date) {
    ...
    Element expiration = Utils.findContainerElseCreate(document,
        shoppingCart, "cart-expiration");
  ...
  public void addAlternateTaxRule(String tableName, boolean standalone,
    ...
    Element newTaxTable = Utils.findContainerWithAttributeValueElseCreate(
        document, alternateTaxTables, "alternate-tax-table", "name",
        tableName);
    ...
    Element newRule = Utils.createNewContainer(document, alternateTaxRules,
        "alternate-tax-rule");
  ...
  public void addDefaultTaxRule(double taxRate, boolean shippingTaxed,
    ...
    Element taxTables = Utils.findContainerElseCreate(document, mcfs,
        "tax-tables");
    Element defaultTaxTable = Utils.findContainerElseCreate(document,
        taxTables, "default-tax-table");
    Element taxRules = Utils.findContainerElseCreate(document,
        defaultTaxTable, "tax-rules");
    
    Element newRule = Utils.createNewContainer(document, taxRules,
        "default-tax-rule");
  ...
  public void setRoundingPolicy(RoundingRule rule, RoundingMode mode) {
    Element mcfs = Utils.findContainerElseCreate(document,
        checkoutFlowSupport, "merchant-checkout-flow-support");
    Element policy = Utils.findContainerElseCreate(document, mcfs,
        "rounding-policy");
