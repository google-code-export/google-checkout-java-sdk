...
public class UrlParameterType {
  ...
  public static UrlParameterType billingCountryCode = 
    new UrlParameterType("billing-country-code");

  /** The five-digit U.S. zip code associated with the order's billing 
   * address. */
  public static UrlParameterType billingPostalCode = 
    new UrlParameterType("billing-postal-code");

  /** The U.S. state associated with the order's billing address. */
  public static UrlParameterType billingRegion = 
    new UrlParameterType("billing-region");
  ...
  public static UrlParameterType orderSubTotal = 
    new UrlParameterType("order-subtotal");
  ...
  public static UrlParameterType orderSubTotalPlusShipping = 
    new UrlParameterType("order-subtotal-plus-shipping");

  /**
   * The total cost for all of the items in the order, including taxes, coupons
   * and discounts, but excluding shipping charges.
   */
  public static UrlParameterType orderSubTotalPlusTax = 
    new UrlParameterType("order-subtotal-plus-tax");

  /**
   * The total cost for all of the items in the order, including taxes, shipping
   * charges, coupons and discounts.
   */
  public static UrlParameterType orderTotal = 
    new UrlParameterType("order-total");

  /** The shipping cost associated with an order. */
  public static UrlParameterType shippingAmount = 
    new UrlParameterType("shipping-amount");

  /** The city associated with the order's shipping address. */
  public static UrlParameterType shippingCity = 
    new UrlParameterType("shipping-city");
  ...
  public static UrlParameterType shippingCountryCode = 
    new UrlParameterType("shipping-country-code");
