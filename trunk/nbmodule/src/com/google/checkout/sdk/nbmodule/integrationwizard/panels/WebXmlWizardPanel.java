...
import com.google.checkout.sdk.nbmodule.integrationwizard.*;
...
public final class WebXmlWizardPanel extends JPanel {
    ...
    private void readWebFragment() {
        InputStream is = this.getClass().getResourceAsStream("/com/google/checkout/sdk/nbmodule/sources/webFragment.xml");
        if (is != null) {
            try {
